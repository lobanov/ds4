...
ifeq ($(UNAME_S),Darwin)
all: ds4 ds4-server ds4-bench ds4-spec-bench ds4-eval ds4-agent

help:
	@echo "DS4 build targets:"
	@echo "  make              Build Metal ./ds4, ./ds4-server, ./ds4-bench, ./ds4-spec-bench, ./ds4-eval, and ./ds4-agent"
	@echo "  make cpu          Build CPU-only ./ds4, ./ds4-server, ./ds4-bench, ./ds4-spec-bench, ./ds4-eval, and ./ds4-agent"
...
ds4-spec-bench: ds4_spec_bench.o $(CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ ds4_spec_bench.o $(CORE_OBJS) $(METAL_LDLIBS)
...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_spec_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_help.o ds4_web.o ds4_kvstore.o linenoise.o rax.o $(CPU_CORE_OBJS)
	...
	$(CC) $(CFLAGS) -o ds4-spec-bench ds4_spec_bench_cpu.o $(CPU_CORE_OBJS) $(LDLIBS)
...
cuda-spark:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-spec-bench ds4-eval ds4-agent CUDA_ARCH=

cuda-generic:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-spec-bench ds4-eval ds4-agent CUDA_ARCH=native
...
cuda:
	...
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-spec-bench ds4-eval ds4-agent CUDA_ARCH="$(CUDA_ARCH)"

strix-halo:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-spec-bench ds4-eval ds4-agent \
...
ds4_spec_bench.o: ds4_spec_bench.c ds4.h ds4_ssd.h
	$(CC) $(CFLAGS) -c -o $@ ds4_spec_bench.c
...
ds4_spec_bench_cpu.o: ds4_spec_bench.c ds4.h ds4_ssd.h
	$(CC) $(CFLAGS) -DDS4_NO_GPU -c -o $@ ds4_spec_bench.c
